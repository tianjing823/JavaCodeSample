...
//    static Logger logger = Logger.getLogger(HttpClientCallSoapUtil.class);  
    ...
    public static String doPostSoap1_1(String postUrl, String soapXml,  
        ...
        try {  
           ...
           // logger.error("exception in doPostSoap1_1", e);  
        	System.out.print("exception in doPostSoap1_1");
        }  
        return retStr;  
    }  
    ...
    public static void main(String[] args) {  
        String soapStart = "<?xml version = \"1.0\" ?>"  
     ...
     ;
    	...
    	String queryXml = "<web:query soapenv:encodingStyle=\"http://schemas.xmlsoap.org/soap/encoding/\">"  
    	...
    	String orderSoapXml = soapStart + orderXml + soapEnd;
    	
    	String querySoapXml = soapStart + queryXml + soapEnd;
